...
/**
 * Created by mahdi on 1/1/2018 AD.
 */
 ...
 */
public class CreditCardEditText implements TextWatcher {
     ...
     */
    public CreditCardEditText(int paddingPx) {
     ...
     */
    public CreditCardEditText(@NonNull TextView textView) {
     ...
     */
    public CreditCardEditText(@NonNull TextView textView, float paddingEm) {
     ...
     */
    public CreditCardEditText(@NonNull Context context, float paddingSp) {
